...
class CodeLoginForm extends Form
{
        ...
        public function initialize($login)
        {
                ...
                $this->setUserOption('information', $this->i18n->_("Select your exam and use your anonymous code as login. Contact the invigilator if you don't know the code.<br><br>Example code: AB-39845"));

                $this->add(new Password('fpass', array('name' => $login->fpass, 'placeholder' => $this->i18n->_('The anonymous code'), 'class' => 'form-control')));
